...
const Aboutme = () => {
  return (
    <div className="bg-red-5000 w-[80%] mx-auto mt-2 h-[300px]d  bg-red-00">
      ...
      <div className="about-wrapper flex flex-col items-center md:flex-row  ">
        <div className="about-image hidden md:block h-96 md:w-[80%] bg-[url('/src/img/33.png')] bg-contain  bg-no-repeat"></div>
        <div className="h-96k px-2">
